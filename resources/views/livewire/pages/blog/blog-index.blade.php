<div class="w-full bg-white">
    <div class="w-full lg:w-7xl max-w-7xl mx-auto px-4 lg:px-0">
        ...
        <div class="flex flex-col max-w-5xl">
            <div class="w-full border-b-[0.8px] border-[#D0D1DA] p-[10px] lg:gap-[10px] my-4 flex justify-between lg:items-center lg:flex-row flex-col-reverse">
                <h1 class="text-[54px] text-[#171E21] satoshi font-[700]">Latest</h1>
                <a href="{{route('blog.add')}}" class="bg-black text-white font-semibold rounded-lg px-4 py-2 h-full text-center">Add New Blog</a>
            </div>

            <div class="flex flex-col w-full divide-y divide-gray-[#D0D1DA]">

                @foreach($posts as $post)
                    <a href="{{route('blog.details',['post' => $post->id])}}" class="flex flex-col lg:flex-row gap-4 py-8">
                        <img class="w-full lg:w-[464px] h-[261px] object-cover object-center" src="{{ \Illuminate\Support\Facades\Storage::url($post->image) }}" class="object-cover object-center" alt="image">
                        <div class="flex flex-col gap-10 lg:max-h-[261px] justify-between">
                            ...
                            <div class="flex flex-col w-full gap-4">
                                ...
                                <div class="flex gap-4">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="inter font-[400] text-[12px] text-[#A3A3AA] mt-1">100</span>
                                    </div>
                                    <div class="flex items-center gap-1">
            ...
            <div class="flex w-full justify-center items-center py-4">
                <button wire:click="loadMore" class="p-[10px] bg-[#6366F1] text-center text-white font-[700] text-[16px] w-[152px] h-[50px]">VIEW MORE</button>
            </div>
